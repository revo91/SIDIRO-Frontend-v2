...
export const GeneratorSVG: React.FC<ITransformerSVGProps> = ({ x, y, name, tableName, activePower, current, powerFactor, voltageApplied, noTable, overview, breakerName }) => {
